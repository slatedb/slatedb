	...
	integrations: [
		starlight({
			...
			head: [
				...
				{
					tag: 'meta',
					attrs: { name: 'go-import', content: 'slatedb.dev/slatedb-go git https://github.com/slatedb/slatedb slatedb-go/go' },
				},
				{
					tag: 'meta',
					attrs: { name: 'go-source', content: 'slatedb.dev/slatedb-go https://github.com/slatedb/slatedb https://github.com/slatedb/slatedb/tree/main/slatedb-go/go{/dir} https://github.com/slatedb/slatedb/blob/main/slatedb-go/go{/dir}/{file}#L{line}' },
				},
			],
			plugins: [
