...
The directory names are mostly self-explanatory:
...
|---------|-----------------|
| Writer | Adds new WAL SSTables. |
| Reader | Creates, deletes, or refreshes checkpoints. |
| Compactor | Adds new sorted runs. |
