...
description: Implement CDC by streaming write-ahead log (WAL) SSTs with WalReader
---
...
`WalReader` does not interpret or compact data. It provides a durable, ordered feed of row-level changes.
