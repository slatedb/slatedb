...
3. Range scan (`Db::scan_rows`) over the cloned database to read old data.
4. Apply the buffered WAL changes in sequence order.
5. Continue tailing WALs from the stored cursor.
