...
This tutorial connects SlateDB to Google Cloud Storage (GCS). You need a GCS account to complete it.
...
The following commands create a storage bucket and generate service account credentials. Skip them if you already have a bucket and service account key.
