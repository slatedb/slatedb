...
This tutorial connects SlateDB to Azure Blob Storage (ABS). You need an Azure account to complete it.
...
The following commands create a storage account and list its keys. Skip them if you already have a storage account.
