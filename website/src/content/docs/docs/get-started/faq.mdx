...
Keys and values are limited to 4 GiB minus one byte (4,294,967,295 bytes). Large keys and values use more memory and take longer to write. Test performance with the sizes that you plan to use.
