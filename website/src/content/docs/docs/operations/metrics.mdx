...
## Testing with DefaultMetricsRecorder

`slatedb-common` ships a `DefaultMetricsRecorder` backed by atomics for use in tests:
...
An OTel recorder maps directly to OTel SDK instruments:
