...
import createCheckpoint from '/../slatedb-examples/src/create_checkpoint.rs?raw';
import refreshCheckpoint from '/../slatedb-examples/src/refresh_checkpoint.rs?raw';
import deleteCheckpoint from '/../slatedb-examples/src/delete_checkpoint.rs?raw';
