...
import { CardGrid, LinkButton, Steps } from '@astrojs/starlight/components';
...
<div id="getting-started" class="getting-started">
    ...
    <Steps>
    1. Add the SlateDB crate to your project:
        ```sh
        cargo add slatedb
        ```
    2. Connect the database to your object store:
        ```rust
        // main.rs
    ...
    <LinkButton
        href="https://github.com/slatedb/slatedb?tab=readme-ov-file#get-started"
        variant="secondary"
        icon="external">
        See a full example
    </LinkButton>
