...
Since SlateDB writes all data to object storage, nodes other than the designated writer can see that data and even modify it in a non-transactional way.
