...
Performance tuning is a never-ending endeavor. We will continue driving SlateDB's cost and latency down while improving its throughput. We now have a means to evaluate that progress. The results are availabe at [benchmark.slatedb.io](https://benchmark.slatedb.io/) if we've piqued your curiosity.
