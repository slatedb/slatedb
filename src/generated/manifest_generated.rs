...
pub enum SstRowExtraOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct SstRowExtra<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for SstRowExtra<'a> {
  type Inner = SstRowExtra<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: flatbuffers::Table::new(buf, loc) }
  }
...
impl<'a> SstRowExtra<'a> {
  pub const VT_CREATED_TS: flatbuffers::VOffsetT = 4;
  pub const VT_EXPIRE_TS: flatbuffers::VOffsetT = 6;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    SstRowExtra { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args SstRowExtraArgs
  ) -> flatbuffers::WIPOffset<SstRowExtra<'bldr>> {
    let mut builder = SstRowExtraBuilder::new(_fbb);
    if let Some(x) = args.expire_ts { builder.add_expire_ts(x); }
    if let Some(x) = args.created_ts { builder.add_created_ts(x); }
    builder.finish()
  }
...
impl flatbuffers::Verifiable for SstRowExtra<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
pub struct SstRowExtraBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SstRowExtraBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<SstRowExtra<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for SstRowExtra<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("SstRowExtra");
      ds.field("created_ts", &self.created_ts());
      ds.field("expire_ts", &self.expire_ts());
      ds.finish()
  }
}
