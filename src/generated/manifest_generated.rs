...
impl CompressionFormat {
    ...
    pub const ENUM_VALUES: &'static [Self] =
        &[Self::None, Self::Snappy, Self::Zlib, Self::Lz4, Self::Zstd];
...
impl CheckpointMetadata {
    ...
    pub const ENUM_VALUES: &'static [Self] = &[Self::NONE, Self::WriterCheckpoint];
    /// Returns the variant's name or "" if unknown.
    pub fn variant_name(self) -> Option<&'static str> {
        match self {
            Self::NONE => Some("NONE"),
...
impl<'a> CompactedSstId<'a> {
    ...
    pub fn high(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(CompactedSstId::VT_HIGH, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn low(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(CompactedSstId::VT_LOW, Some(0))
                .unwrap()
        }
    }
}
...
impl<'a> Default for CompactedSstIdArgs {
    #[inline]
    fn default() -> Self {
        CompactedSstIdArgs { high: 0, low: 0 }
    }
}
...
impl<'a> CompactedSsTable<'a> {
    ...
    pub fn id(&self) -> CompactedSstId<'a> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<CompactedSstId>>(CompactedSsTable::VT_ID, None)
                .unwrap()
        }
    }
    #[inline]
    pub fn info(&self) -> SsTableInfo<'a> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<SsTableInfo>>(CompactedSsTable::VT_INFO, None)
                .unwrap()
        }
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> CompactedSsTableBuilder<'a, 'b, A> {
    ...
    pub fn add_id(&mut self, id: flatbuffers::WIPOffset<CompactedSstId<'b>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<CompactedSstId>>(
                CompactedSsTable::VT_ID,
                id,
            );
    }
    #[inline]
    pub fn add_info(&mut self, info: flatbuffers::WIPOffset<SsTableInfo<'b>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<SsTableInfo>>(
                CompactedSsTable::VT_INFO,
                info,
            );
    }
    #[inline]
...
impl<'a> SsTableInfo<'a> {
    ...
    pub fn index_offset(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(SsTableInfo::VT_INDEX_OFFSET, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn index_len(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(SsTableInfo::VT_INDEX_LEN, Some(0))
                .unwrap()
        }
    }
    #[inline]
        ...
        unsafe {
            self._tab
                .get::<CompressionFormat>(
                    SsTableInfo::VT_COMPRESSION_FORMAT,
...
impl flatbuffers::Verifiable for SsTableInfo<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<CompressionFormat>(
                "compression_format",
                Self::VT_COMPRESSION_FORMAT,
                false,
            )?
            .finish();
        Ok(())
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SsTableInfoBuilder<'a, 'b, A> {
    ...
    pub fn add_index_offset(&mut self, index_offset: u64) {
        self.fbb_
            .push_slot::<u64>(SsTableInfo::VT_INDEX_OFFSET, index_offset, 0);
    }
    #[inline]
    pub fn add_index_len(&mut self, index_len: u64) {
        self.fbb_
            .push_slot::<u64>(SsTableInfo::VT_INDEX_LEN, index_len, 0);
    }
    #[inline]
    ...
    pub fn block_meta(
        ...
        unsafe {
            self._tab
                ...
                >>(SsTableIndex::VT_BLOCK_META, None)
                .unwrap()
        }
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SsTableIndexBuilder<'a, 'b, A> {
    ...
    pub fn add_block_meta(
        ...
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(SsTableIndex::VT_BLOCK_META, block_meta);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> SsTableIndexBuilder<'a, 'b, A> {
        let start = _fbb.start_table();
        SsTableIndexBuilder {
            fbb_: _fbb,
            start_: start,
    ...
    pub fn finish(self) -> flatbuffers::WIPOffset<SsTableIndex<'a>> {
        let o = self.fbb_.end_table(self.start_);
        self.fbb_
            .required(o, SsTableIndex::VT_BLOCK_META, "block_meta");
        flatbuffers::WIPOffset::new(o.value())
    }
}
...
impl<'a> ExternalDb<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
        ...
        if let Some(x) = args.sst_ids {
            builder.add_sst_ids(x);
        }
        if let Some(x) = args.final_checkpoint_id {
            builder.add_final_checkpoint_id(x);
        }
        if let Some(x) = args.source_checkpoint_id {
            builder.add_source_checkpoint_id(x);
        }
    ...
    pub fn path(&self) -> &'a str {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(ExternalDb::VT_PATH, None)
                .unwrap()
        }
    }
    #[inline]
    pub fn source_checkpoint_id(&self) -> Uuid<'a> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Uuid>>(
                    ExternalDb::VT_SOURCE_CHECKPOINT_ID,
                    None,
                )
                .unwrap()
        }
    ...
    pub fn final_checkpoint_id(&self) -> Option<Uuid<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Uuid>>(ExternalDb::VT_FINAL_CHECKPOINT_ID, None)
        }
    }
    #[inline]
    pub fn sst_ids(
        &self,
    ) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CompactedSstId<'a>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CompactedSstId>>,
                >>(ExternalDb::VT_SST_IDS, None)
                .unwrap()
        }
    }
}
...
impl flatbuffers::Verifiable for ExternalDb<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<Uuid>>(
                "source_checkpoint_id",
                Self::VT_SOURCE_CHECKPOINT_ID,
                true,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<Uuid>>(
                "final_checkpoint_id",
                Self::VT_FINAL_CHECKPOINT_ID,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<CompactedSstId>>,
            >>("sst_ids", Self::VT_SST_IDS, true)?
            .finish();
        Ok(())
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ExternalDbBuilder<'a, 'b, A> {
    ...
    pub fn add_path(&mut self, path: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(ExternalDb::VT_PATH, path);
    }
    #[inline]
    pub fn add_source_checkpoint_id(
        &mut self,
        source_checkpoint_id: flatbuffers::WIPOffset<Uuid<'b>>,
    ) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Uuid>>(
            ExternalDb::VT_SOURCE_CHECKPOINT_ID,
            source_checkpoint_id,
        );
    }
    #[inline]
    pub fn add_final_checkpoint_id(
        &mut self,
        final_checkpoint_id: flatbuffers::WIPOffset<Uuid<'b>>,
    ) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<Uuid>>(
            ExternalDb::VT_FINAL_CHECKPOINT_ID,
            final_checkpoint_id,
        );
    }
    #[inline]
    pub fn add_sst_ids(
        &mut self,
        sst_ids: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<CompactedSstId<'b>>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(ExternalDb::VT_SST_IDS, sst_ids);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> ExternalDbBuilder<'a, 'b, A> {
        let start = _fbb.start_table();
        ExternalDbBuilder {
            fbb_: _fbb,
            start_: start,
...
impl<'a> ManifestV1<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
        ...
        if let Some(x) = args.compacted {
            builder.add_compacted(x);
        }
        if let Some(x) = args.l0 {
            builder.add_l0(x);
        }
        if let Some(x) = args.l0_last_compacted {
            builder.add_l0_last_compacted(x);
        }
        if let Some(x) = args.external_dbs {
            builder.add_external_dbs(x);
        }
    ...
    pub fn manifest_id(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(ManifestV1::VT_MANIFEST_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn external_dbs(
        &self,
    ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ExternalDb<'a>>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ExternalDb>>,
            >>(ManifestV1::VT_EXTERNAL_DBS, None)
        }
    }
    #[inline]
    pub fn initialized(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(ManifestV1::VT_INITIALIZED, Some(false))
                .unwrap()
        }
    }
    #[inline]
    pub fn writer_epoch(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(ManifestV1::VT_WRITER_EPOCH, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn compactor_epoch(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(ManifestV1::VT_COMPACTOR_EPOCH, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn last_l0_recent_flushed_wal_id(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(ManifestV1::VT_LAST_L0_RECENT_FLUSHED_WAL_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn wal_id_last_seen(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(ManifestV1::VT_WAL_ID_LAST_SEEN, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn l0_last_compacted(&self) -> Option<CompactedSstId<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<CompactedSstId>>(
                    ManifestV1::VT_L0_LAST_COMPACTED,
                    None,
                )
        }
    }
    ...
    pub fn l0(
        &self,
    ) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CompactedSsTable<'a>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CompactedSsTable>>,
                >>(ManifestV1::VT_L0, None)
                .unwrap()
        }
    }
    #[inline]
    pub fn compacted(
        &self,
    ) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SortedRun<'a>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SortedRun>>,
                >>(ManifestV1::VT_COMPACTED, None)
                .unwrap()
        }
    }
    #[inline]
    pub fn last_l0_clock_tick(&self) -> i64 {
        ...
        unsafe {
            self._tab
                .get::<i64>(ManifestV1::VT_LAST_L0_CLOCK_TICK, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn checkpoints(
        ...
        unsafe {
            self._tab
                ...
                >>(ManifestV1::VT_CHECKPOINTS, None)
                .unwrap()
        }
    }
    #[inline]
    pub fn last_l0_seq(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(ManifestV1::VT_LAST_L0_SEQ, Some(0))
                .unwrap()
        }
    }
}
...
impl flatbuffers::Verifiable for ManifestV1<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<ExternalDb>>,
            >>("external_dbs", Self::VT_EXTERNAL_DBS, false)?
            ...
            .visit_field::<u64>(
                "last_l0_recent_flushed_wal_id",
                Self::VT_LAST_L0_RECENT_FLUSHED_WAL_ID,
                false,
            )?
            .visit_field::<u64>("wal_id_last_seen", Self::VT_WAL_ID_LAST_SEEN, false)?
            .visit_field::<flatbuffers::ForwardsUOffset<CompactedSstId>>(
                "l0_last_compacted",
                Self::VT_L0_LAST_COMPACTED,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<CompactedSsTable>>,
            >>("l0", Self::VT_L0, true)?
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<SortedRun>>,
            >>("compacted", Self::VT_COMPACTED, true)?
            ...
            >>("checkpoints", Self::VT_CHECKPOINTS, true)?
...
pub struct ManifestV1Args<'a> {
    pub manifest_id: u64,
    pub external_dbs: Option<
        flatbuffers::WIPOffset<
            flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ExternalDb<'a>>>,
        >,
    >,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ManifestV1Builder<'a, 'b, A> {
    ...
    pub fn add_manifest_id(&mut self, manifest_id: u64) {
        self.fbb_
            .push_slot::<u64>(ManifestV1::VT_MANIFEST_ID, manifest_id, 0);
    }
    #[inline]
    pub fn add_external_dbs(
        &mut self,
        external_dbs: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<ExternalDb<'b>>>,
        >,
    ) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            ManifestV1::VT_EXTERNAL_DBS,
            external_dbs,
        );
    }
    #[inline]
    pub fn add_initialized(&mut self, initialized: bool) {
        self.fbb_
            .push_slot::<bool>(ManifestV1::VT_INITIALIZED, initialized, false);
    }
    #[inline]
    pub fn add_writer_epoch(&mut self, writer_epoch: u64) {
        self.fbb_
            .push_slot::<u64>(ManifestV1::VT_WRITER_EPOCH, writer_epoch, 0);
    }
    #[inline]
    pub fn add_compactor_epoch(&mut self, compactor_epoch: u64) {
        self.fbb_
            .push_slot::<u64>(ManifestV1::VT_COMPACTOR_EPOCH, compactor_epoch, 0);
    }
    #[inline]
    pub fn add_last_l0_recent_flushed_wal_id(&mut self, last_l0_recent_flushed_wal_id: u64) {
        self.fbb_.push_slot::<u64>(
            ManifestV1::VT_LAST_L0_RECENT_FLUSHED_WAL_ID,
            last_l0_recent_flushed_wal_id,
            0,
        );
    }
    ...
    pub fn add_wal_id_last_seen(&mut self, wal_id_last_seen: u64) {
        self.fbb_
            .push_slot::<u64>(ManifestV1::VT_WAL_ID_LAST_SEEN, wal_id_last_seen, 0);
    }
    #[inline]
    pub fn add_l0_last_compacted(
        &mut self,
        l0_last_compacted: flatbuffers::WIPOffset<CompactedSstId<'b>>,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<CompactedSstId>>(
                ManifestV1::VT_L0_LAST_COMPACTED,
    ...
    pub fn add_l0(
        &mut self,
        l0: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<CompactedSsTable<'b>>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(ManifestV1::VT_L0, l0);
    }
    #[inline]
    pub fn add_compacted(
        &mut self,
        compacted: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<SortedRun<'b>>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(ManifestV1::VT_COMPACTED, compacted);
    }
    #[inline]
    pub fn add_last_l0_clock_tick(&mut self, last_l0_clock_tick: i64) {
        self.fbb_
            .push_slot::<i64>(ManifestV1::VT_LAST_L0_CLOCK_TICK, last_l0_clock_tick, 0);
    }
    #[inline]
    pub fn add_checkpoints(
        ...
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(ManifestV1::VT_CHECKPOINTS, checkpoints);
    }
    #[inline]
    pub fn add_last_l0_seq(&mut self, last_l0_seq: u64) {
        self.fbb_
            .push_slot::<u64>(ManifestV1::VT_LAST_L0_SEQ, last_l0_seq, 0);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> ManifestV1Builder<'a, 'b, A> {
        let start = _fbb.start_table();
        ManifestV1Builder {
            fbb_: _fbb,
            start_: start,
    ...
    pub fn finish(self) -> flatbuffers::WIPOffset<ManifestV1<'a>> {
        ...
        self.fbb_
            .required(o, ManifestV1::VT_CHECKPOINTS, "checkpoints");
        flatbuffers::WIPOffset::new(o.value())
    }
}
...
impl core::fmt::Debug for ManifestV1<'_> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        ...
        ds.field(
            "last_l0_recent_flushed_wal_id",
            &self.last_l0_recent_flushed_wal_id(),
        );
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SortedRunBuilder<'a, 'b, A> {
    ...
    pub fn add_ssts(
        &mut self,
        ssts: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<CompactedSsTable<'b>>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(SortedRun::VT_SSTS, ssts);
    }
    #[inline]
...
impl<'a> WriterCheckpoint<'a> {
    ...
    pub fn epoch(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(WriterCheckpoint::VT_EPOCH, Some(0))
                .unwrap()
        }
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> WriterCheckpointBuilder<'a, 'b, A> {
    ...
    pub fn add_epoch(&mut self, epoch: u64) {
        self.fbb_
            .push_slot::<u64>(WriterCheckpoint::VT_EPOCH, epoch, 0);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> WriterCheckpointBuilder<'a, 'b, A> {
        let start = _fbb.start_table();
...
impl<'a> Checkpoint<'a> {
    ...
    pub fn id(&self) -> Uuid<'a> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<Uuid>>(Checkpoint::VT_ID, None)
                .unwrap()
        }
    }
    #[inline]
    pub fn manifest_id(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(Checkpoint::VT_MANIFEST_ID, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn checkpoint_expire_time_s(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(Checkpoint::VT_CHECKPOINT_EXPIRE_TIME_S, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn checkpoint_create_time_s(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(Checkpoint::VT_CHECKPOINT_CREATE_TIME_S, Some(0))
                .unwrap()
        }
    }
    #[inline]
        ...
        unsafe {
            self._tab
                .get::<CheckpointMetadata>(
                    Checkpoint::VT_METADATA_TYPE,
                    Some(CheckpointMetadata::NONE),
                )
                .unwrap()
        }
    }
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<u32>(
                ...
                Self::VT_CHECKPOINT_EXPIRE_TIME_S,
                false,
            )?
            .visit_field::<u32>(
                "checkpoint_create_time_s",
                Self::VT_CHECKPOINT_CREATE_TIME_S,
                false,
            )?
            .visit_union::<CheckpointMetadata, _>(
                "metadata_type",
                Self::VT_METADATA_TYPE,
                "metadata",
                Self::VT_METADATA,
                false,
                |key, v, pos| match key {
                    CheckpointMetadata::WriterCheckpoint => v
                        .verify_union_variant::<flatbuffers::ForwardsUOffset<WriterCheckpoint>>(
                            "CheckpointMetadata::WriterCheckpoint",
                            pos,
                        ),
                    _ => Ok(()),
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> CheckpointBuilder<'a, 'b, A> {
    ...
    pub fn add_id(&mut self, id: flatbuffers::WIPOffset<Uuid<'b>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<Uuid>>(Checkpoint::VT_ID, id);
    }
    #[inline]
    pub fn add_manifest_id(&mut self, manifest_id: u64) {
        self.fbb_
            .push_slot::<u64>(Checkpoint::VT_MANIFEST_ID, manifest_id, 0);
    }
    #[inline]
    pub fn add_checkpoint_expire_time_s(&mut self, checkpoint_expire_time_s: u32) {
        self.fbb_.push_slot::<u32>(
            Checkpoint::VT_CHECKPOINT_EXPIRE_TIME_S,
            checkpoint_expire_time_s,
            0,
        );
    }
    ...
    pub fn add_checkpoint_create_time_s(&mut self, checkpoint_create_time_s: u32) {
        self.fbb_.push_slot::<u32>(
            Checkpoint::VT_CHECKPOINT_CREATE_TIME_S,
            checkpoint_create_time_s,
            0,
        );
    }
    ...
    pub fn add_metadata_type(&mut self, metadata_type: CheckpointMetadata) {
        self.fbb_.push_slot::<CheckpointMetadata>(
            Checkpoint::VT_METADATA_TYPE,
            metadata_type,
            CheckpointMetadata::NONE,
        );
    ...
    pub fn add_metadata(&mut self, metadata: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Checkpoint::VT_METADATA, metadata);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
