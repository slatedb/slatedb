...
use crate::compactor::{default_compaction_scheduler, CompactionSchedulerSupplier};
...
/// Database options for SlateDB.
///
/// Note: This struct is deprecated and will be removed in a future release.
/// Please use the `Settings` type and the builder API in `Db` instead.
#[deprecated(
    since = "0.7.0",
    note = "Use `Settings` and the builder API in `Db` instead"
)]
pub type DbOptions = Settings;
...
pub struct Settings {
    ...
    ///
    /// Note: This is not a setting but a component. It will be moved to the builder API in a future release.
    #[deprecated(
        since = "0.7.0",
        note = "Use the Db::builder.with_block_cache() method instead"
    )]
    #[serde(skip)]
    ...
    #[deprecated(
        since = "0.7.0",
        note = "Use the Db::builder.with_clock() method instead"
    )]
...
// Deserialize the settings from a JSON string.
// This is needed because the block cache and clock are boxed trait objects
// and the code generated by the serde macro for deserializing
// those fields issues a warning because the fields are being accessed.
//
// TODO: This custom deserialization can be removed once the deprecated fields
...
impl<'de> Deserialize<'de> for Settings {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        struct SettingsHelper {
            ...
            garbage_collector_options: Option<GarbageCollectorOptions>,
        ...
        #[allow(deprecated)]
        Ok(Settings {
            flush_interval: helper.flush_interval,
            #[cfg(feature = "wal_disable")]
            wal_enabled: helper.wal_enabled,
            manifest_poll_interval: helper.manifest_poll_interval,
            min_filter_keys: helper.min_filter_keys,
            filter_bits_per_key: helper.filter_bits_per_key,
            l0_sst_size_bytes: helper.l0_sst_size_bytes,
            l0_max_ssts: helper.l0_max_ssts,
            max_unflushed_bytes: helper.max_unflushed_bytes,
            compactor_options: helper.compactor_options,
            compression_codec: helper.compression_codec,
            object_store_cache_options: helper.object_store_cache_options,
            block_cache: default_block_cache(),
            garbage_collector_options: helper.garbage_collector_options,
            clock: default_clock(),
            default_ttl: helper.default_ttl,
        })
    }
}
...
pub struct CompactorOptions {
    ...
    #[deprecated(
        since = "0.7.0",
        note = "Use the Db::builder.with_compaction_scheduler_supplier() method instead"
    )]
    ...
    #[deprecated(
        since = "0.7.0",
        note = "Use the Db::builder.with_compaction_runtime() method instead"
    )]
    #[serde(skip)]
    pub compaction_runtime: Option<Handle>,
}

// Deserialize the compactor options from a JSON string.
// This is needed because the compaction scheduler is a boxed trait object
// and the code generated by the serde macro for deserializing
// that field, it issues a warning because the field is being accessed.
//
// TODO: This custom deserialization can be removed once the deprecated fields
// are removed from CompactorOptions.
impl<'de> Deserialize<'de> for CompactorOptions {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        #[derive(Deserialize)]
        #[serde(rename = "CompactorOptions")]
        struct CompactorOptionsHelper {
            #[serde(deserialize_with = "deserialize_duration")]
        ...
        let helper = CompactorOptionsHelper::deserialize(deserializer)?;

        #[allow(deprecated)]
        Ok(CompactorOptions {
            poll_interval: helper.poll_interval,
            max_sst_size: helper.max_sst_size,
            max_concurrent_compactions: helper.max_concurrent_compactions,
...
pub struct GarbageCollectorOptions {
    ...
    #[deprecated(
        since = "0.7.0",
        note = "Use the Db::builder.with_gc_runtime() method instead"
    )]
    #[serde(skip)]
