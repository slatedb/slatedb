...
<<<<<<< HEAD
=======
use crate::inmemory_cache::{InMemoryCache, InMemoryCacheOptions};
>>>>>>> feat(cache): Add option to provide a cache instance.
...
pub struct DbOptions {
    ...
    pub block_cache_instance: Option<Arc<dyn InMemoryCache>>,
