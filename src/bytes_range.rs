...
pub(crate) mod tests {
    ...
    fn test_bytes_union() {
        assert_eq!(
            BytesRange::from_ref("a".."d").union(&BytesRange::from_ref("d".."e")),
            Some(BytesRange::from_ref("a".."e"))
        );
        assert_eq!(
            BytesRange::from_ref("a".."d").union(&BytesRange::from_ref("e".."f")),
            None
        );
        assert_eq!(
            BytesRange::from_ref("a"..="d").union(&BytesRange::from_ref("d".."e")),
        ...
        assert_eq!(
            BytesRange::from_ref(..="f").union(&BytesRange::from_ref("d".."e")),
            Some(BytesRange::from_ref(..="f"))
        );
        assert_eq!(
            BytesRange::from_ref(..="f").union(&BytesRange::from_ref("e".."f")),
            Some(BytesRange::from_ref(..="f"))
        );
        assert_eq!(
            BytesRange::from_ref("f".."m").union(&BytesRange::from_ref("a".."g")),
