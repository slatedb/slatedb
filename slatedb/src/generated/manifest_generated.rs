...
impl<'a> ManifestV1<'a> {
  ...
  pub const VT_MIN_RETENTION_SEQ: flatbuffers::VOffsetT = 32;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    builder.add_min_retention_seq(args.min_retention_seq);
  ...
  #[inline]
  pub fn min_retention_seq(&self) -> u64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u64>(ManifestV1::VT_MIN_RETENTION_SEQ, Some(0)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for ManifestV1<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<u64>("min_retention_seq", Self::VT_MIN_RETENTION_SEQ, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ManifestV1Builder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_min_retention_seq(&mut self, min_retention_seq: u64) {
    self.fbb_.push_slot::<u64>(ManifestV1::VT_MIN_RETENTION_SEQ, min_retention_seq, 0);
  }
  #[inline]
...
impl core::fmt::Debug for ManifestV1<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("ManifestV1");
      ...
      ds.field("min_retention_seq", &self.min_retention_seq());
      ds.finish()
  }
}
