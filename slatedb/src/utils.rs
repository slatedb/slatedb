...
/// Watch the source chain for an object store error
/// to figure out if it was generated by a time out error.
pub(crate) fn object_store_timedout(error: &SlateDBError) -> bool {
    let SlateDBError::ObjectStoreError(e) = error else {
        return false;
    };
