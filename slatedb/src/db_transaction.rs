...
pub struct DbTransaction {
    ...
    txn_id: Uuid,
    /// Snapshot providing sequence number and compaction protection
    snapshot: DbSnapshot,
...
impl DbTransaction {
    ...
    pub(crate) fn new(
        ...
        let snapshot = DbSnapshot::new(db_inner.clone(), Some(seq));

        Self {
            txn_id,
            snapshot: Arc::unwrap_or_clone(snapshot), // this txn should be the only owner of this snapshot
            txn_manager,
