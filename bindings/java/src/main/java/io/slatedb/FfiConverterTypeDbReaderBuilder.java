...
public enum FfiConverterTypeDbReaderBuilder implements FfiConverter<DbReaderBuilder, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(DbReaderBuilder value) {
        return value.uniffiClonePointer();
    }

    @Override
    public DbReaderBuilder lift(Pointer value) {
        return new DbReaderBuilder(value);
    }

    @Override
    public DbReaderBuilder read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(DbReaderBuilder value) {
      return 8L;
    }

    @Override
    public void write(DbReaderBuilder value, ByteBuffer buf) {
