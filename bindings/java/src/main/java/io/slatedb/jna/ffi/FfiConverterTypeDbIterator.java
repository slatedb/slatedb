...
public enum FfiConverterTypeDbIterator implements FfiConverter<DbIterator, Pointer> {
  INSTANCE;

  @Override
  public Pointer lower(DbIterator value) {
    return value.uniffiClonePointer();
  }

  @Override
  public DbIterator lift(Pointer value) {
    return new DbIterator(value);
  }

  @Override
  public DbIterator read(ByteBuffer buf) {
  ...
  @Override
  public long allocationSize(DbIterator value) {
    return 8L;
  }

  @Override
  public void write(DbIterator value, ByteBuffer buf) {
