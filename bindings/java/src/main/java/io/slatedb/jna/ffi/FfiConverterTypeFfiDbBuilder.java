...
public enum FfiConverterTypeFfiDbBuilder implements FfiConverter<FfiDbBuilder, Pointer> {
  INSTANCE;

  @Override
  public Pointer lower(FfiDbBuilder value) {
    return value.uniffiClonePointer();
  }

  @Override
  public FfiDbBuilder lift(Pointer value) {
    return new FfiDbBuilder(value);
  }

  @Override
  public FfiDbBuilder read(ByteBuffer buf) {
  ...
  @Override
  public long allocationSize(FfiDbBuilder value) {
    return 8L;
  }

  @Override
  public void write(FfiDbBuilder value, ByteBuffer buf) {
