...
/**
 * This is a helper for safely working with byte buffers returned from the Rust code. A rust-owned
 * buffer is represented by its capacity, its current length, and a pointer to the underlying data.
 */
