...
public enum FfiConverterTypeFfiMergeOperator implements FfiConverter<FfiMergeOperator, Pointer> {
  INSTANCE;
  public final UniffiHandleMap<FfiMergeOperator> handleMap = new UniffiHandleMap<>();

  @Override
  public Pointer lower(FfiMergeOperator value) {
    return new Pointer(handleMap.insert(value));
  }

  @Override
  public FfiMergeOperator lift(Pointer value) {
    return new FfiMergeOperatorImpl(value);
  }

  @Override
  public FfiMergeOperator read(ByteBuffer buf) {
  ...
  @Override
  public long allocationSize(FfiMergeOperator value) {
    return 8L;
  }

  @Override
  public void write(FfiMergeOperator value, ByteBuffer buf) {
