...
public enum FfiConverterTypeFfiDbReader implements FfiConverter<FfiDbReader, Pointer> {
  INSTANCE;

  @Override
  public Pointer lower(FfiDbReader value) {
    return value.uniffiClonePointer();
  }

  @Override
  public FfiDbReader lift(Pointer value) {
    return new FfiDbReader(value);
  }

  @Override
  public FfiDbReader read(ByteBuffer buf) {
  ...
  @Override
  public long allocationSize(FfiDbReader value) {
    return 8L;
  }

  @Override
  public void write(FfiDbReader value, ByteBuffer buf) {
