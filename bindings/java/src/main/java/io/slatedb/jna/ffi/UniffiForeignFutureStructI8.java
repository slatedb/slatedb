...
public class UniffiForeignFutureStructI8 extends Structure {
  ...
  public UniffiForeignFutureStructI8(byte returnValue, UniffiRustCallStatus.ByValue callStatus) {
    this.returnValue = returnValue;
    this.callStatus = callStatus;
  }

  public static class UniffiByValue extends UniffiForeignFutureStructI8
