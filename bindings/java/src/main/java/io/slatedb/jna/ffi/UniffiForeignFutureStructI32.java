...
public class UniffiForeignFutureStructI32 extends Structure {
  ...
  public UniffiForeignFutureStructI32(int returnValue, UniffiRustCallStatus.ByValue callStatus) {
    this.returnValue = returnValue;
    this.callStatus = callStatus;
  }

  public static class UniffiByValue extends UniffiForeignFutureStructI32
