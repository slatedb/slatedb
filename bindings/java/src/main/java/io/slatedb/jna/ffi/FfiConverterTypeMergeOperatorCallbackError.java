...
public enum FfiConverterTypeMergeOperatorCallbackError
    implements FfiConverterRustBuffer<MergeOperatorCallbackException> {
  INSTANCE;
  ...
  public MergeOperatorCallbackException read(ByteBuffer buf) {
    ...
    return switch (buf.getInt()) {
      case 1 -> new MergeOperatorCallbackException.Failed(FfiConverterString.INSTANCE.read(buf));
