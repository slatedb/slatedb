...
public enum FfiConverterTypeWalFileIterator implements FfiConverter<WalFileIterator, Pointer> {
  INSTANCE;

  @Override
  public Pointer lower(WalFileIterator value) {
    return value.uniffiClonePointer();
  }

  @Override
  public WalFileIterator lift(Pointer value) {
    return new WalFileIterator(value);
  }

  @Override
  public WalFileIterator read(ByteBuffer buf) {
  ...
  @Override
  public long allocationSize(WalFileIterator value) {
    return 8L;
  }

  @Override
  public void write(WalFileIterator value, ByteBuffer buf) {
