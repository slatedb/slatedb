...
public enum FfiConverterTypeDb implements FfiConverter<Db, Pointer> {
  INSTANCE;

  @Override
  public Pointer lower(Db value) {
    return value.uniffiClonePointer();
  }

  @Override
  public Db lift(Pointer value) {
    return new Db(value);
  }

  @Override
  public Db read(ByteBuffer buf) {
  ...
  @Override
  public long allocationSize(Db value) {
    return 8L;
  }

  @Override
  public void write(Db value, ByteBuffer buf) {
