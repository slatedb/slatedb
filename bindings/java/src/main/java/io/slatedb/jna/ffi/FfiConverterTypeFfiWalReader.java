...
public enum FfiConverterTypeFfiWalReader implements FfiConverter<FfiWalReader, Pointer> {
  INSTANCE;

  @Override
  public Pointer lower(FfiWalReader value) {
    return value.uniffiClonePointer();
  }

  @Override
  public FfiWalReader lift(Pointer value) {
    return new FfiWalReader(value);
  }

  @Override
  public FfiWalReader read(ByteBuffer buf) {
  ...
  @Override
  public long allocationSize(FfiWalReader value) {
    return 8L;
  }

  @Override
  public void write(FfiWalReader value, ByteBuffer buf) {
