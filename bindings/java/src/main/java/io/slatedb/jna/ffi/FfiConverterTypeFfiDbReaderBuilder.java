...
public enum FfiConverterTypeFfiDbReaderBuilder
    implements FfiConverter<FfiDbReaderBuilder, Pointer> {
  INSTANCE;

  @Override
  public Pointer lower(FfiDbReaderBuilder value) {
    return value.uniffiClonePointer();
  }

  @Override
  public FfiDbReaderBuilder lift(Pointer value) {
    return new FfiDbReaderBuilder(value);
  }

  @Override
  public FfiDbReaderBuilder read(ByteBuffer buf) {
  ...
  @Override
  public long allocationSize(FfiDbReaderBuilder value) {
    return 8L;
  }

  @Override
  public void write(FfiDbReaderBuilder value, ByteBuffer buf) {
