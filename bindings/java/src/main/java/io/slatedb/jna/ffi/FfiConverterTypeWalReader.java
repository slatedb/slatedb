...
public enum FfiConverterTypeWalReader implements FfiConverter<WalReader, Pointer> {
  INSTANCE;

  @Override
  public Pointer lower(WalReader value) {
    return value.uniffiClonePointer();
  }

  @Override
  public WalReader lift(Pointer value) {
    return new WalReader(value);
  }

  @Override
  public WalReader read(ByteBuffer buf) {
  ...
  @Override
  public long allocationSize(WalReader value) {
    return 8L;
  }

  @Override
  public void write(WalReader value, ByteBuffer buf) {
