...
public enum FfiConverterTypeFfiObjectStore implements FfiConverter<FfiObjectStore, Pointer> {
  INSTANCE;

  @Override
  public Pointer lower(FfiObjectStore value) {
    return value.uniffiClonePointer();
  }

  @Override
  public FfiObjectStore lift(Pointer value) {
    return new FfiObjectStore(value);
  }

  @Override
  public FfiObjectStore read(ByteBuffer buf) {
  ...
  @Override
  public long allocationSize(FfiObjectStore value) {
    return 8L;
  }

  @Override
  public void write(FfiObjectStore value, ByteBuffer buf) {
