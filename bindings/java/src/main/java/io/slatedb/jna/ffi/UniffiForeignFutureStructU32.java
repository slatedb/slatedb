...
public class UniffiForeignFutureStructU32 extends Structure {
  ...
  public UniffiForeignFutureStructU32(int returnValue, UniffiRustCallStatus.ByValue callStatus) {
    this.returnValue = returnValue;
    this.callStatus = callStatus;
  }

  public static class UniffiByValue extends UniffiForeignFutureStructU32
      implements Structure.ByValue {
    public UniffiByValue(int returnValue, UniffiRustCallStatus.ByValue callStatus) {
