...
public enum FfiConverterTypeFfiDbSnapshot implements FfiConverter<FfiDbSnapshot, Pointer> {
  INSTANCE;

  @Override
  public Pointer lower(FfiDbSnapshot value) {
    return value.uniffiClonePointer();
  }

  @Override
  public FfiDbSnapshot lift(Pointer value) {
    return new FfiDbSnapshot(value);
  }

  @Override
  public FfiDbSnapshot read(ByteBuffer buf) {
  ...
  @Override
  public long allocationSize(FfiDbSnapshot value) {
    return 8L;
  }

  @Override
  public void write(FfiDbSnapshot value, ByteBuffer buf) {
