...
public class FfiWalFile implements AutoCloseable, FfiWalFileInterface {
  ...
  public FfiWalFile(Pointer pointer) {
   ...
   */
  public FfiWalFile(NoPointer noPointer) {
    this.pointer = null;
    this.cleanable = UniffiLib.CLEANER.register(this, new UniffiCleanAction(pointer));
  }
  ...
  public <R> R callWithPointer(Function<Pointer, R> block) {
    ...
    do {
      ...
      if (c == 0L) {
        throw new IllegalStateException("FfiWalFile object has already been destroyed");
      }
      if (c == Long.MAX_VALUE) {
        throw new IllegalStateException("FfiWalFile call counter would overflow");
      }
    ...
    public void run() {
      if (pointer != null) {
        UniffiHelpers.uniffiRustCall(
            status -> {
              UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_free_ffiwalfile(pointer, status);
              return null;
            });
      }
    }
  ...
  Pointer uniffiClonePointer() {
    return UniffiHelpers.uniffiRustCall(
        status -> {
          ...
          return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_clone_ffiwalfile(pointer, status);
        });
  }
          ...
          callWithPointer(
              it -> {
                try {
                  ...
                  return UniffiHelpers.uniffiRustCall(
                      _status -> {
                        return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_ffiwalfile_id(
                            it, _status);
                      });
  ...
  public CompletableFuture<FfiWalFileIterator> iterator() {
    return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(
            thisPtr -> {
              return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_ffiwalfile_iterator(thisPtr);
            }),
        ...
        // lift function
        (it) -> FfiConverterTypeFfiWalFileIterator.INSTANCE.lift(it),
        // Error FFI converter
  ...
  public CompletableFuture<FfiWalFileMetadata> metadata() {
    return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(
            thisPtr -> {
              return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_ffiwalfile_metadata(thisPtr);
            }),
        (future, callback, continuation) ->
        ...
        // lift function
        (it) -> FfiConverterTypeFfiWalFileMetadata.INSTANCE.lift(it),
        // Error FFI converter
        new FfiExceptionErrorHandler());
  }
  ...
  public FfiWalFile nextFile() {
    try {
      return FfiConverterTypeFfiWalFile.INSTANCE.lift(
          callWithPointer(
              it -> {
                try {
                  ...
                  return UniffiHelpers.uniffiRustCall(
                      _status -> {
                        return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_ffiwalfile_next_file(
                            it, _status);
                      });
          ...
          callWithPointer(
              it -> {
                try {
                  ...
                  return UniffiHelpers.uniffiRustCall(
                      _status -> {
                        return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_ffiwalfile_next_id(
                            it, _status);
                      });
          ...
          it -> {
            try {
              ...
              UniffiHelpers.uniffiRustCallWithError(
                  new FfiExceptionErrorHandler(),
                  _status -> {
                    UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_ffiwalfile_shutdown(
                        it, _status);
                  });
