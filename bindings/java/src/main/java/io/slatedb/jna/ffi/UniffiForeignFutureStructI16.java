...
public class UniffiForeignFutureStructI16 extends Structure {
  ...
  public UniffiForeignFutureStructI16(short returnValue, UniffiRustCallStatus.ByValue callStatus) {
    this.returnValue = returnValue;
    this.callStatus = callStatus;
  }

  public static class UniffiByValue extends UniffiForeignFutureStructI16
