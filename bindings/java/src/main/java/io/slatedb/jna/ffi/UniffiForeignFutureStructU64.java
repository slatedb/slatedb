...
public class UniffiForeignFutureStructU64 extends Structure {
  ...
  public UniffiForeignFutureStructU64(long returnValue, UniffiRustCallStatus.ByValue callStatus) {
    this.returnValue = returnValue;
    this.callStatus = callStatus;
  }

  public static class UniffiByValue extends UniffiForeignFutureStructU64
