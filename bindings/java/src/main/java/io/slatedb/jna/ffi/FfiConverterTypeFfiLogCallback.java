...
public enum FfiConverterTypeFfiLogCallback implements FfiConverter<FfiLogCallback, Pointer> {
  INSTANCE;
  public final UniffiHandleMap<FfiLogCallback> handleMap = new UniffiHandleMap<>();

  @Override
  public Pointer lower(FfiLogCallback value) {
    return new Pointer(handleMap.insert(value));
  }

  @Override
  public FfiLogCallback lift(Pointer value) {
    return new FfiLogCallbackImpl(value);
  }
