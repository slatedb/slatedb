...
public class UniffiForeignFutureStructF32 extends Structure {
  ...
  public UniffiForeignFutureStructF32(float returnValue, UniffiRustCallStatus.ByValue callStatus) {
    this.returnValue = returnValue;
    this.callStatus = callStatus;
  }

  public static class UniffiByValue extends UniffiForeignFutureStructF32
      implements Structure.ByValue {
    public UniffiByValue(float returnValue, UniffiRustCallStatus.ByValue callStatus) {
