...
public enum FfiConverterTypeSettings implements FfiConverter<Settings, Pointer> {
  INSTANCE;

  @Override
  public Pointer lower(Settings value) {
    return value.uniffiClonePointer();
  }

  @Override
  public Settings lift(Pointer value) {
    return new Settings(value);
  }

  @Override
  public Settings read(ByteBuffer buf) {
  ...
  @Override
  public long allocationSize(Settings value) {
    return 8L;
  }

  @Override
  public void write(Settings value, ByteBuffer buf) {
