...
public class UniffiVTableCallbackInterfaceMergeOperator extends Structure {
  ...
  public UniffiVTableCallbackInterfaceMergeOperator(
      UniffiCallbackInterfaceMergeOperatorMethod0 merge, UniffiCallbackInterfaceFree uniffiFree) {
    this.merge = merge;
    this.uniffiFree = uniffiFree;
  }

  public static class UniffiByValue extends UniffiVTableCallbackInterfaceMergeOperator
