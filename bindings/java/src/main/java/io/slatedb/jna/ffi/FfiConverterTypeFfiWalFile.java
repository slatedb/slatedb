...
public enum FfiConverterTypeFfiWalFile implements FfiConverter<FfiWalFile, Pointer> {
  INSTANCE;

  @Override
  public Pointer lower(FfiWalFile value) {
    return value.uniffiClonePointer();
  }

  @Override
  public FfiWalFile lift(Pointer value) {
    return new FfiWalFile(value);
  }

  @Override
  public FfiWalFile read(ByteBuffer buf) {
  ...
  @Override
  public long allocationSize(FfiWalFile value) {
    return 8L;
  }

  @Override
  public void write(FfiWalFile value, ByteBuffer buf) {
