...
public class UniffiForeignFutureStructI64 extends Structure {
  ...
  public UniffiForeignFutureStructI64(long returnValue, UniffiRustCallStatus.ByValue callStatus) {
    this.returnValue = returnValue;
    this.callStatus = callStatus;
  }

  public static class UniffiByValue extends UniffiForeignFutureStructI64
      implements Structure.ByValue {
    public UniffiByValue(long returnValue, UniffiRustCallStatus.ByValue callStatus) {
