...
public class FfiKeyValue {
  ...
  public FfiKeyValue(byte[] key, byte[] value, Long seq, Long createTs, Long expireTs) {
  ...
  public boolean equals(Object other) {
    if (other instanceof FfiKeyValue) {
      FfiKeyValue t = (FfiKeyValue) other;
