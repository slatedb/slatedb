...
public class UniffiForeignFutureStructU16 extends Structure {
  ...
  public UniffiForeignFutureStructU16(short returnValue, UniffiRustCallStatus.ByValue callStatus) {
    this.returnValue = returnValue;
    this.callStatus = callStatus;
  }

  public static class UniffiByValue extends UniffiForeignFutureStructU16
      implements Structure.ByValue {
    public UniffiByValue(short returnValue, UniffiRustCallStatus.ByValue callStatus) {
