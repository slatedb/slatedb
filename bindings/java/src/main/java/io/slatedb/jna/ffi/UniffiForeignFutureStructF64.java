...
public class UniffiForeignFutureStructF64 extends Structure {
  ...
  public UniffiForeignFutureStructF64(double returnValue, UniffiRustCallStatus.ByValue callStatus) {
    this.returnValue = returnValue;
    this.callStatus = callStatus;
  }

  public static class UniffiByValue extends UniffiForeignFutureStructF64
      implements Structure.ByValue {
    public UniffiByValue(double returnValue, UniffiRustCallStatus.ByValue callStatus) {
