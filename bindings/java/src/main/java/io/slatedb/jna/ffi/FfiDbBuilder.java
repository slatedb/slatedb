...
public class FfiDbBuilder implements AutoCloseable, FfiDbBuilderInterface {
  ...
  public FfiDbBuilder(Pointer pointer) {
   ...
   */
  public FfiDbBuilder(NoPointer noPointer) {
    this.pointer = null;
    this.cleanable = UniffiLib.CLEANER.register(this, new UniffiCleanAction(pointer));
  }

  public FfiDbBuilder(String path, FfiObjectStore objectStore) {
    this(
        (Pointer)
            UniffiHelpers.uniffiRustCall(
                _status -> {
                  return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_constructor_ffidbbuilder_new(
  ...
  public <R> R callWithPointer(Function<Pointer, R> block) {
    ...
    do {
      ...
      if (c == 0L) {
        throw new IllegalStateException("FfiDbBuilder object has already been destroyed");
      }
      if (c == Long.MAX_VALUE) {
        throw new IllegalStateException("FfiDbBuilder call counter would overflow");
      }
  ...
  private class UniffiCleanAction implements Runnable {
    ...
    public void run() {
      if (pointer != null) {
        UniffiHelpers.uniffiRustCall(
            status -> {
              UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_free_ffidbbuilder(pointer, status);
              return null;
            });
      }
    }
  ...
  Pointer uniffiClonePointer() {
    return UniffiHelpers.uniffiRustCall(
        status -> {
          ...
          return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_clone_ffidbbuilder(pointer, status);
        });
  }
  ...
  public CompletableFuture<FfiDb> build() {
    return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(
            thisPtr -> {
              return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_ffidbbuilder_build(thisPtr);
            }),
        ...
        // lift function
        (it) -> FfiConverterTypeFfiDb.INSTANCE.lift(it),
        // Error FFI converter
          ...
          it -> {
            try {
              ...
              UniffiHelpers.uniffiRustCallWithError(
                  ...
                  _status -> {
                    UniffiLib.INSTANCE
                        .uniffi_slatedb_ffi_fn_method_ffidbbuilder_with_db_cache_disabled(
                            it, _status);
                  });
          ...
          it -> {
            try {
              ...
              UniffiHelpers.uniffiRustCallWithError(
                  ...
                  _status -> {
                    UniffiLib.INSTANCE
                        .uniffi_slatedb_ffi_fn_method_ffidbbuilder_with_merge_operator(
                            it,
          ...
          it -> {
            try {
              ...
              UniffiHelpers.uniffiRustCallWithError(
                  new FfiExceptionErrorHandler(),
                  _status -> {
                    UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_ffidbbuilder_with_seed(
          ...
          it -> {
            try {
              ...
              UniffiHelpers.uniffiRustCallWithError(
                  new FfiExceptionErrorHandler(),
                  _status -> {
                    UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_ffidbbuilder_with_settings(
                        it, FfiConverterTypeFfiSettings.INSTANCE.lower(settings), _status);
                  });
          ...
          it -> {
            try {
              ...
              UniffiHelpers.uniffiRustCallWithError(
                  ...
                  _status -> {
                    UniffiLib.INSTANCE
                        .uniffi_slatedb_ffi_fn_method_ffidbbuilder_with_sst_block_size(
                            it,
                            FfiConverterTypeFfiSstBlockSize.INSTANCE.lower(sstBlockSize),
                            _status);
                  });
          ...
          it -> {
            try {
              ...
              UniffiHelpers.uniffiRustCallWithError(
                  ...
                  _status -> {
                    UniffiLib.INSTANCE
                        .uniffi_slatedb_ffi_fn_method_ffidbbuilder_with_wal_object_store(
                            it,
