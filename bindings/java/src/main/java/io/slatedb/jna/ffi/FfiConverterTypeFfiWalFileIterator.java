...
public enum FfiConverterTypeFfiWalFileIterator
    implements FfiConverter<FfiWalFileIterator, Pointer> {
  INSTANCE;

  @Override
  public Pointer lower(FfiWalFileIterator value) {
    return value.uniffiClonePointer();
  }

  @Override
  public FfiWalFileIterator lift(Pointer value) {
    return new FfiWalFileIterator(value);
  }

  @Override
  public FfiWalFileIterator read(ByteBuffer buf) {
  ...
  @Override
  public long allocationSize(FfiWalFileIterator value) {
    return 8L;
  }

  @Override
  public void write(FfiWalFileIterator value, ByteBuffer buf) {
