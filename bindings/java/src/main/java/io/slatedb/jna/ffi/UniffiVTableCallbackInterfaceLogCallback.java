...
public class UniffiVTableCallbackInterfaceLogCallback extends Structure {
  ...
  public UniffiVTableCallbackInterfaceLogCallback(
      UniffiCallbackInterfaceLogCallbackMethod0 log, UniffiCallbackInterfaceFree uniffiFree) {
    this.log = log;
    this.uniffiFree = uniffiFree;
  }

  public static class UniffiByValue extends UniffiVTableCallbackInterfaceLogCallback
