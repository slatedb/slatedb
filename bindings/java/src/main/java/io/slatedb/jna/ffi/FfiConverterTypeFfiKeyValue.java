...
public enum FfiConverterTypeFfiKeyValue implements FfiConverterRustBuffer<FfiKeyValue> {
  INSTANCE;

  @Override
  public FfiKeyValue read(ByteBuffer buf) {
    return new FfiKeyValue(
  ...
  public long allocationSize(FfiKeyValue value) {
    return (FfiConverterByteArray.INSTANCE.allocationSize(value.key())
