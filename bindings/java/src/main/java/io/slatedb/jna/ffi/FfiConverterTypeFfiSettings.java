...
public enum FfiConverterTypeFfiSettings implements FfiConverter<FfiSettings, Pointer> {
  INSTANCE;

  @Override
  public Pointer lower(FfiSettings value) {
    return value.uniffiClonePointer();
  }

  @Override
  public FfiSettings lift(Pointer value) {
    return new FfiSettings(value);
  }

  @Override
  public FfiSettings read(ByteBuffer buf) {
  ...
  @Override
  public long allocationSize(FfiSettings value) {
    return 8L;
  }

  @Override
  public void write(FfiSettings value, ByteBuffer buf) {
