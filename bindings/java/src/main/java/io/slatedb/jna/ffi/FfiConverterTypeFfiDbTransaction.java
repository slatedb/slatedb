...
public enum FfiConverterTypeFfiDbTransaction implements FfiConverter<FfiDbTransaction, Pointer> {
  INSTANCE;

  @Override
  public Pointer lower(FfiDbTransaction value) {
    return value.uniffiClonePointer();
  }

  @Override
  public FfiDbTransaction lift(Pointer value) {
    return new FfiDbTransaction(value);
  }

  @Override
  public FfiDbTransaction read(ByteBuffer buf) {
  ...
  @Override
  public long allocationSize(FfiDbTransaction value) {
    return 8L;
  }

  @Override
  public void write(FfiDbTransaction value, ByteBuffer buf) {
