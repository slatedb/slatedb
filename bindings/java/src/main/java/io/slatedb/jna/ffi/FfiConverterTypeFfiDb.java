...
public enum FfiConverterTypeFfiDb implements FfiConverter<FfiDb, Pointer> {
  INSTANCE;

  @Override
  public Pointer lower(FfiDb value) {
    return value.uniffiClonePointer();
  }

  @Override
  public FfiDb lift(Pointer value) {
    return new FfiDb(value);
  }

  @Override
  public FfiDb read(ByteBuffer buf) {
  ...
  @Override
  public long allocationSize(FfiDb value) {
    return 8L;
  }

  @Override
  public void write(FfiDb value, ByteBuffer buf) {
