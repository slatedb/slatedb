...
public enum FfiConverterTypeDbReader implements FfiConverter<DbReader, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(DbReader value) {
        return value.uniffiClonePointer();
    }

    @Override
    public DbReader lift(Pointer value) {
        return new DbReader(value);
    }

    @Override
    public DbReader read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(DbReader value) {
      return 8L;
    }

    @Override
    public void write(DbReader value, ByteBuffer buf) {
