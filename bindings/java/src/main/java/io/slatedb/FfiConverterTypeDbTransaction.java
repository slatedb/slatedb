...
public enum FfiConverterTypeDbTransaction implements FfiConverter<DbTransaction, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(DbTransaction value) {
        return value.uniffiClonePointer();
    }

    @Override
    public DbTransaction lift(Pointer value) {
        return new DbTransaction(value);
    }

    @Override
    public DbTransaction read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(DbTransaction value) {
      return 8L;
    }

    @Override
    public void write(DbTransaction value, ByteBuffer buf) {
