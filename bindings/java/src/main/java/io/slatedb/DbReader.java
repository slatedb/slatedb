 ...
 */
public class DbReader implements DbReaderInterface {
    ...
    public void run() {
      if (pointer != null) {
        UniffiHelpers.uniffiRustCall(status -> {
          UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_free_dbreader(pointer, status);
          return null;
        });
      }
    }
  ...
  Pointer uniffiClonePointer() {
    return UniffiHelpers.uniffiRustCall(status -> {
      ...
      return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_clone_dbreader(pointer, status);
    });
  }
    ...
    public CompletableFuture<Void> close(){
        ...
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbreader_close(
                thisPtr
    ...
    public CompletableFuture<byte[]> get(byte[] key){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbreader_get(
                thisPtr,
    ...
    public CompletableFuture<byte[]> getWithOptions(byte[] key, DbReadOptions options){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbreader_get_with_options(
                thisPtr,
    ...
    public CompletableFuture<DbIterator> scan(DbKeyRange range){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbreader_scan(
                thisPtr,
    ...
    public CompletableFuture<DbIterator> scanPrefix(byte[] prefix){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbreader_scan_prefix(
                thisPtr,
    ...
    public CompletableFuture<DbIterator> scanPrefixWithOptions(byte[] prefix, DbScanOptions options){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbreader_scan_prefix_with_options(
                thisPtr,
    ...
    public CompletableFuture<DbIterator> scanWithOptions(DbKeyRange range, DbScanOptions options){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbreader_scan_with_options(
                thisPtr,
