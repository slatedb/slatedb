...
public class DbTransaction implements AutoCloseable, DbTransactionInterface {
    ...
    public void run() {
      if (pointer != null) {
        UniffiHelpers.uniffiRustCall(status -> {
          UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_free_dbtransaction(pointer, status);
          return null;
        });
      }
    }
  ...
  Pointer uniffiClonePointer() {
    return UniffiHelpers.uniffiRustCall(status -> {
      ...
      return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_clone_dbtransaction(pointer, status);
    });
  }
    ...
    public CompletableFuture<WriteHandle> commit(){
        ...
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_commit(
                thisPtr
    ...
    public CompletableFuture<WriteHandle> commitWithOptions(DbWriteOptions options){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_commit_with_options(
                thisPtr,
                FfiConverterTypeDbWriteOptions.INSTANCE.lower(options)
            );
        }),
        (future, callback, continuation) -> UniffiLib.INSTANCE.ffi_slatedb_ffi_rust_future_poll_rust_buffer(future, callback, continuation),
        (future, continuation) -> UniffiLib.INSTANCE.ffi_slatedb_ffi_rust_future_complete_rust_buffer(future, continuation),
    ...
    public CompletableFuture<Void> delete(byte[] key){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_delete(
                thisPtr,
    ...
    public CompletableFuture<byte[]> get(byte[] key){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_get(
                thisPtr,
                FfiConverterByteArray.INSTANCE.lower(key)
            );
        }),
    ...
    public CompletableFuture<KeyValue> getKeyValue(byte[] key){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_get_key_value(
                thisPtr,
                FfiConverterByteArray.INSTANCE.lower(key)
            );
        }),
    ...
    public CompletableFuture<KeyValue> getKeyValueWithOptions(byte[] key, DbReadOptions options){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_get_key_value_with_options(
                thisPtr,
    ...
    public CompletableFuture<byte[]> getWithOptions(byte[] key, DbReadOptions options){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_get_with_options(
                thisPtr,
                FfiConverterByteArray.INSTANCE.lower(key), FfiConverterTypeDbReadOptions.INSTANCE.lower(options)
            );
        }),
    ...
    UniffiHelpers.uniffiRustCall( _status -> {
        return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_id(
            it, _status);
    });
    ...
    public CompletableFuture<Void> markRead(List<byte[]> keys){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_mark_read(
                thisPtr,
    ...
    public CompletableFuture<Void> merge(byte[] key, byte[] operand){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_merge(
                thisPtr,
    ...
    public CompletableFuture<Void> mergeWithOptions(byte[] key, byte[] operand, DbMergeOptions options){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_merge_with_options(
                thisPtr,
                FfiConverterByteArray.INSTANCE.lower(key), FfiConverterByteArray.INSTANCE.lower(operand), FfiConverterTypeDbMergeOptions.INSTANCE.lower(options)
            );
        }),
        (future, callback, continuation) -> UniffiLib.INSTANCE.ffi_slatedb_ffi_rust_future_poll_void(future, callback, continuation),
        (future, continuation) -> UniffiLib.INSTANCE.ffi_slatedb_ffi_rust_future_complete_void(future, continuation),
    ...
    public CompletableFuture<Void> put(byte[] key, byte[] value){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_put(
                thisPtr,
    ...
    public CompletableFuture<Void> putWithOptions(byte[] key, byte[] value, DbPutOptions options){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_put_with_options(
                thisPtr,
                FfiConverterByteArray.INSTANCE.lower(key), FfiConverterByteArray.INSTANCE.lower(value), FfiConverterTypeDbPutOptions.INSTANCE.lower(options)
            );
        }),
        (future, callback, continuation) -> UniffiLib.INSTANCE.ffi_slatedb_ffi_rust_future_poll_void(future, callback, continuation),
        (future, continuation) -> UniffiLib.INSTANCE.ffi_slatedb_ffi_rust_future_complete_void(future, continuation),
    ...
    public CompletableFuture<Void> rollback(){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_rollback(
                thisPtr
    ...
    public CompletableFuture<DbIterator> scan(DbKeyRange range){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_scan(
                thisPtr,
    ...
    public CompletableFuture<DbIterator> scanPrefix(byte[] prefix){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_scan_prefix(
                thisPtr,
    ...
    public CompletableFuture<DbIterator> scanPrefixWithOptions(byte[] prefix, DbScanOptions options){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_scan_prefix_with_options(
                thisPtr,
    ...
    public CompletableFuture<DbIterator> scanWithOptions(DbKeyRange range, DbScanOptions options){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_scan_with_options(
                thisPtr,
    ...
    callWithPointer(it -> {
        try {
            ...
            return
    UniffiHelpers.uniffiRustCall( _status -> {
        return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_seqnum(
            it, _status);
    });
    ...
    public CompletableFuture<Void> unmarkWrite(List<byte[]> keys){
        return UniffiAsyncHelpers.uniffiRustCallAsync(
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_ffi_fn_method_dbtransaction_unmark_write(
                thisPtr,
                FfiConverterSequenceByteArray.INSTANCE.lower(keys)
            );
        }),
