...
public class UniffiCallbackInterfaceMergeOperator {
    public static final UniffiCallbackInterfaceMergeOperator INSTANCE = new UniffiCallbackInterfaceMergeOperator();
    UniffiVTableCallbackInterfaceMergeOperator.UniffiByValue vtable;
    
    UniffiCallbackInterfaceMergeOperator() {
        vtable = new UniffiVTableCallbackInterfaceMergeOperator.UniffiByValue(
            merge.INSTANCE,
            UniffiFree.INSTANCE
        );
    }
    ...
    public static class merge implements UniffiCallbackInterfaceMergeOperatorMethod0 {
        ...
        @Override
        public void callback(long uniffiHandle,RustBuffer.ByValue key,RustBuffer.ByValue existingValue,RustBuffer.ByValue operand,RustBuffer uniffiOutReturn,UniffiRustCallStatus uniffiCallStatus) {
            ...
            Consumer<byte[]> writeReturn = (byte[] value) -> { uniffiOutReturn.setValue(FfiConverterByteArray.INSTANCE.lower(value)); };
            UniffiHelpers.uniffiTraitInterfaceCallWithError(
                uniffiCallStatus,
                makeCall,
                writeReturn,
                (MergeOperatorCallbackException e) -> { return FfiConverterTypeMergeOperatorCallbackError.INSTANCE.lower(e); },
