  ...
  Pointer uniffiClonePointer() {
    ...
    callWithPointer(it -> {
        try {
            ...
            return
    UniffiHelpers.uniffiRustCallWithError(new MergeOperatorCallbackExceptionErrorHandler(), _status -> {
        return UniffiLib.INSTANCE.uniffi_slatedb_uniffi_fn_method_mergeoperator_merge(
            it, FfiConverterByteArray.INSTANCE.lower(key), FfiConverterOptionalByteArray.INSTANCE.lower(existingValue), FfiConverterByteArray.INSTANCE.lower(operand), _status);
    });
