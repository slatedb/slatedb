...
public class WriteBatch implements AutoCloseable, WriteBatchInterface {
  ...
  Pointer uniffiClonePointer() {
    ...
    UniffiHelpers.uniffiRustCallWithError(new ErrorErrorHandler(), _status -> {
        UniffiLib.INSTANCE.uniffi_slatedb_uniffi_fn_method_writebatch_merge_with_options(
            it, FfiConverterByteArray.INSTANCE.lower(key), FfiConverterByteArray.INSTANCE.lower(operand), FfiConverterTypeMergeOptions.INSTANCE.lower(options), _status);
    });
    ...
    UniffiHelpers.uniffiRustCallWithError(new ErrorErrorHandler(), _status -> {
        UniffiLib.INSTANCE.uniffi_slatedb_uniffi_fn_method_writebatch_put_with_options(
            it, FfiConverterByteArray.INSTANCE.lower(key), FfiConverterByteArray.INSTANCE.lower(value), FfiConverterTypePutOptions.INSTANCE.lower(options), _status);
    });
