...
public enum FfiConverterTypeDbBuilder implements FfiConverter<DbBuilder, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(DbBuilder value) {
        return value.uniffiClonePointer();
    }

    @Override
    public DbBuilder lift(Pointer value) {
        return new DbBuilder(value);
    }

    @Override
    public DbBuilder read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(DbBuilder value) {
      return 8L;
    }

    @Override
    public void write(DbBuilder value, ByteBuffer buf) {
