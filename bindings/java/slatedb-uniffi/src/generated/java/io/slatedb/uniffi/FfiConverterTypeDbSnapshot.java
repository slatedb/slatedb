...
public enum FfiConverterTypeDbSnapshot implements FfiConverter<DbSnapshot, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(DbSnapshot value) {
        return value.uniffiClonePointer();
    }

    @Override
    public DbSnapshot lift(Pointer value) {
        return new DbSnapshot(value);
    }

    @Override
    public DbSnapshot read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(DbSnapshot value) {
      return 8L;
    }

    @Override
    public void write(DbSnapshot value, ByteBuffer buf) {
