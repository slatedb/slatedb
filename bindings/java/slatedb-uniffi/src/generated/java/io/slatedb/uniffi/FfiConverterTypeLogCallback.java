...
public enum FfiConverterTypeLogCallback implements FfiConverter<LogCallback, Pointer> {
    INSTANCE;
    public final UniffiHandleMap<LogCallback> handleMap = new UniffiHandleMap<>();

    @Override
    public Pointer lower(LogCallback value) {
        return new Pointer(handleMap.insert(value));
    }

    @Override
    public LogCallback lift(Pointer value) {
