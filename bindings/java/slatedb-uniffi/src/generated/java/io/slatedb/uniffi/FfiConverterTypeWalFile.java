...
public enum FfiConverterTypeWalFile implements FfiConverter<WalFile, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(WalFile value) {
        return value.uniffiClonePointer();
    }

    @Override
    public WalFile lift(Pointer value) {
        return new WalFile(value);
    }

    @Override
    public WalFile read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(WalFile value) {
      return 8L;
    }

    @Override
    public void write(WalFile value, ByteBuffer buf) {
