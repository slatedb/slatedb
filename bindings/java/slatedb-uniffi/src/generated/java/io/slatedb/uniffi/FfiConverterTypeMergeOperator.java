...
public enum FfiConverterTypeMergeOperator implements FfiConverter<MergeOperator, Pointer> {
    INSTANCE;
    public final UniffiHandleMap<MergeOperator> handleMap = new UniffiHandleMap<>();

    @Override
    public Pointer lower(MergeOperator value) {
        return new Pointer(handleMap.insert(value));
    }

    @Override
    public MergeOperator lift(Pointer value) {
        return new MergeOperatorImpl(value);
    }

    @Override
    public MergeOperator read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(MergeOperator value) {
      return 8L;
    }

    @Override
    public void write(MergeOperator value, ByteBuffer buf) {
