...
public class DbBuilder implements AutoCloseable, DbBuilderInterface {
  ...
  public DbBuilder(String path, ObjectStore objectStore) {
    ...
    UniffiHelpers.uniffiRustCall( _status -> {
        return UniffiLib.INSTANCE.uniffi_slatedb_uniffi_fn_constructor_dbbuilder_new(
    ...
    public void run() {
      if (pointer != null) {
        UniffiHelpers.uniffiRustCall(status -> {
          UniffiLib.INSTANCE.uniffi_slatedb_uniffi_fn_free_dbbuilder(pointer, status);
          return null;
        });
      }
    }
  ...
  Pointer uniffiClonePointer() {
    return UniffiHelpers.uniffiRustCall(status -> {
      ...
      return UniffiLib.INSTANCE.uniffi_slatedb_uniffi_fn_clone_dbbuilder(pointer, status);
    });
  }
    ...
    public CompletableFuture<Db> build(){
        ...
        callWithPointer(thisPtr -> {
            return UniffiLib.INSTANCE.uniffi_slatedb_uniffi_fn_method_dbbuilder_build(
                thisPtr
    ...
    UniffiHelpers.uniffiRustCallWithError(new ErrorErrorHandler(), _status -> {
        UniffiLib.INSTANCE.uniffi_slatedb_uniffi_fn_method_dbbuilder_with_db_cache_disabled(
            it, _status);
    });
    ...
    UniffiHelpers.uniffiRustCallWithError(new ErrorErrorHandler(), _status -> {
        UniffiLib.INSTANCE.uniffi_slatedb_uniffi_fn_method_dbbuilder_with_merge_operator(
    ...
    UniffiHelpers.uniffiRustCallWithError(new ErrorErrorHandler(), _status -> {
        UniffiLib.INSTANCE.uniffi_slatedb_uniffi_fn_method_dbbuilder_with_seed(
    ...
    UniffiHelpers.uniffiRustCallWithError(new ErrorErrorHandler(), _status -> {
        UniffiLib.INSTANCE.uniffi_slatedb_uniffi_fn_method_dbbuilder_with_settings(
            it, FfiConverterTypeSettings.INSTANCE.lower(settings), _status);
    });
    ...
    UniffiHelpers.uniffiRustCallWithError(new ErrorErrorHandler(), _status -> {
        UniffiLib.INSTANCE.uniffi_slatedb_uniffi_fn_method_dbbuilder_with_sst_block_size(
    ...
    UniffiHelpers.uniffiRustCallWithError(new ErrorErrorHandler(), _status -> {
        UniffiLib.INSTANCE.uniffi_slatedb_uniffi_fn_method_dbbuilder_with_wal_object_store(
