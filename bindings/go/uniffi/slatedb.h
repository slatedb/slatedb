...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_SLATEDB_UNIFFI_FN_METHOD_ADMIN_CREATE_CLONE_BUILDER
#define UNIFFI_FFIDEF_UNIFFI_SLATEDB_UNIFFI_FN_METHOD_ADMIN_CREATE_CLONE_BUILDER
uint64_t uniffi_slatedb_uniffi_fn_method_admin_create_clone_builder(uint64_t ptr, RustBuffer parent_path, RustBuffer parent_checkpoint, RustCallStatus *out_status
);
#endif
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_SLATEDB_UNIFFI_CHECKSUM_METHOD_ADMIN_CREATE_CLONE_BUILDER
#define UNIFFI_FFIDEF_UNIFFI_SLATEDB_UNIFFI_CHECKSUM_METHOD_ADMIN_CREATE_CLONE_BUILDER
uint16_t uniffi_slatedb_uniffi_checksum_method_admin_create_clone_builder(void
